...
- [Copy & Paste] the Git clone you find in the code button git@github.com:albertkantwi/bookstore.git into your terminal and press [Enter]
...
- git clone git@github.com:albertkantwi/bookstore.git
...
Feel free to check the [issues page](https://github.com/albertkantwi/bookstore/issues).
